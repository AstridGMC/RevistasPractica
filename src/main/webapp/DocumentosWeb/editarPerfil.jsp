...
<html>
    ...
    <servlet>
        <servlet-name>../editarMiPerfil</servlet-name>
        <servlet-class>../editarMiPerfil</servlet-class>
    </servlet>
    <%
    ...
    <div class="perfil">
        ...
        <form action="<%=request.getContextPath()%>/editarMiPerfil" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" id="div1">
                ...
                <div>
                    <textarea readonly class="form-control" rows="3"name="gustos" id="datos1" placeholder ="cuentanos tus gustos personales"></textarea>
                </div>
            </div>
            <div class="form-group" id="div1">
                <label class="titulos" id="as">Intereses </label>
                <div class="col-sm-10">
                    <textarea readonly="readonly" class="form-control" value="<%= request.getAttribute("intereses") %>" rows="3" name="intereses" id="datos2" placeholder ="cuentanos tus inereses"></textarea>
                </div>
            </div>
            <div class="form-group" id="div1">
                <label class="titulos" id="as">Descripcion </label>
                <div class="col-sm-10">
                    <textarea readonly class="form-control" rows="3" name="descripcion" value="<%= request.getAttribute("descripcion")%>" id="datos3" ></textarea>
                </div>
            </div>
            <div class="form-group" id="div1">
                <label class="titulos" id="as">Hobbies </label>
                <div class="col-sm-10">
                    <textarea readonly class="form-control" rows="3" name="hobbies" value="<% request.getAttribute("hobbies");%>" id="datos4" placeholder ="cuentanos tus hobbies"></textarea>
                </div>
            </div>
            <br>
            <br>
